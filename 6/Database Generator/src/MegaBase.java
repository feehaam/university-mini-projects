...
//            System.out.println("++++++++"+cd);
            for(int i=0; i<covid19Infections.length; i++)
                  ...
                  else if(covid19Infections[i].equals("Affected") && lungs[i].equals("Weak") && r.nextInt(100)>60)
...
//Generating File
            FFiles.createFolder("F:\\Data");
            FFiles.delete("F:\\Data");
            FFiles.createFolder("F:\\Data");
            int div = 20000;
            int requiredFolder = (N)/div + 1;
            for(int i = 1; i<=requiredFolder; i++){
                  FFiles.create("F:\\Data\\Person "+i+".txt");
                  FFiles.create("F:\\Data\\Body_condition "+i+".txt");
                  FFiles.create("F:\\Data\\Covid19 "+i+".txt");
                  FFiles.create("F:\\Data\\Hiv "+i+".txt");
                  FFiles.create("F:\\Data\\Dengue "+i+".txt");
                  FFiles.create("F:\\Data\\Hepatitis_B "+i+".txt");
                  FFiles.create("F:\\Data\\Cholera "+i+".txt");
                  FFiles.create("F:\\Data\\Pulmonary_Tuberculosis "+i+".txt");
            }
            String Data = "";
            ...
            for(int ii=1; ii<=requiredFolder; ii++){
                  ...
                  for(int i=ii*div-div; i<ii*div; i++){
                        ...
                        if((i+2)%100 == 0){
                                    FFiles.addTo("F:\\Data\\Person "+(ii*1)+ ".txt", Data);
                                    Data = "";
            }     }     }
            ...
            for(int ii=1; ii<=requiredFolder; ii++){
                  ...
                  for(int i=ii*div-div; i<ii*div; i++){
                        ...
                        if((i+2)%100 == 0){
                                    FFiles.addTo("F:\\Data\\Body_Condition "+(ii*1)+ ".txt", Data);
                                    Data = "";
            }     }     }
            ...
            for(int ii=1; ii<=requiredFolder; ii++){
                  ...
                  for(int i=ii*div-div; i<ii*div; i++){
                        ...
                        if((i+2)%100 == 0){
                                    FFiles.addTo("F:\\Data\\Covid19 "+(ii*1)+ ".txt", Data);
                                    Data = "";
            }     }     }
            ...
            for(int ii=1; ii<=requiredFolder; ii++){
                  ...
                  for(int i=ii*div-div; i<ii*div; i++){
                        ...
                        if((i+2)%100 == 0){
                                    FFiles.addTo("F:\\Data\\Hiv "+(ii*1)+ ".txt", Data);
                                    Data = "";
            }     }     }
            ...
            for(int ii=1; ii<=requiredFolder; ii++){
                  ...
                  for(int i=ii*div-div; i<ii*div; i++){
                        ...
                        if((i+2)%100 == 0){
                                    FFiles.addTo("F:\\Data\\Dengue "+(ii*1)+ ".txt", Data);
                                    Data = "";
            }     }     }
            ...
            for(int ii=1; ii<=requiredFolder; ii++){
                  ...
                  for(int i=ii*div-div; i<ii*div; i++){
                        ...
                        if((i+2)%100 == 0){
                                    FFiles.addTo("F:\\Data\\Hepatitis_B "+(ii*1)+ ".txt", Data);
                                    Data = "";
            }     }     }
            ...
            for(int ii=1; ii<=requiredFolder; ii++){
                  ...
                  for(int i=ii*div-div; i<ii*div; i++){
                        ...
                        if((i+2)%100 == 0){
                                    FFiles.addTo("F:\\Data\\Cholera "+(ii*1)+ ".txt", Data);
                                    Data = "";
            }     }     }
            ...
            for(int ii=1; ii<=requiredFolder; ii++){
                  ...
                  for(int i=ii*div-div; i<ii*div; i++){
                        ...
                        if((i+2)%100 == 0){
                                    FFiles.addTo("F:\\Data\\Pulmonary_Tuberculosis "+(ii*1)+ ".txt", Data);
                                    Data = "";
            }     }     }
